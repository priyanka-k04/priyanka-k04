...
<table>
  <tr>
    <td valign="top" width="58%">
      ...
      <ul>
        <li><strong>Now:</strong> RAG, embeddings, Grad-CAM / XAI, agentic prototypes</li>
        <li><strong>Collaborate on:</strong> GenAI products, open-source ML, applied NLP</li>
        <li><strong>Ask me about:</strong> Django, FAISS, deepfake detection, AI products</li>
        <li><strong>Based at:</strong> Banasthali Vidyapith, Rajasthan</li>
      </ul>
    </td>
...
| [**Chatbot-Mindwell**](https://github.com/priyanka-k04/Chatbot-Mindwell) | A support-focused conversational assistant designed with product-first thinking. |
| [**ImagoAI**](https://github.com/priyanka-k04/ImagoAI) | Applied AI experiments around intelligent image-driven workflows and intelligent automation. |
| [**Hindi Stemmer**](https://github.com/priyanka-k04/Hindi_Stemmer) | NLP tooling built for Hindi morphological stemming and text-processing tasks. |
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/FAISS-EE4C2C?style=for-the-badge&logo=meta&logoColor=white" alt="FAISS" />
</p>

<p align="center">
  <strong>Apps & data</strong><br />
...
- Retrieval and reasoning stacks: embeddings, FAISS, RAG pipelines
- LLM workflows that stay explainable and reliable
- Deployment patterns for AI products using containers and cloud tooling
- Explainability for high-impact predictions in domains like deepfake detection
